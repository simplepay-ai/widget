                                        ...
                                        ${
                                                this.products.map((item: Product) => html`
                                                    <div class="productItem">
                                                        ...
                                                        <div class="controls">
                                                            ...
                                                            ${
                                                                ...
                                                                ? html`
                                                                                <div class="button" @click=${() => this.dispatchRemoveFromCart(item.id)}>
                                                            ...
                                                            <div class="button" @click=${() => this.dispatchAddToCart(item.id)}>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                                     viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                                     stroke-width="1.5" stroke-linecap="round"
                                                                     stroke-linejoin="round">
                                                    ...
                                                    ${
                                                            ( this.cart.find((product) => product.id === item.id) )
                                                                    ? html`
                                                                                <p class="cartText">In cart x${this.cart.find((product) => product.id === item.id)?.count}</p>
                                                                            `
                                                                    : ''
                                                    }
                                                `)
